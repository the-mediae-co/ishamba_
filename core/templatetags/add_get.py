...
Source: https://djangosnippets.org/snippets/2428/
"""
...
class AddGetParameter(Node):
    ...
    def render(self, context):
        # Modified to return an empty string if the context does not contain
        # a request. This is necessary for django_tables2 ExportMixin to work
        # properly when combined with this.
        try:
            ...
            for key, value in self.values.items():
                ...
                # customisation to wrap tags in double quotes
                if key == 'tags' and ' ' in val:
                    val = '"{}"'.format(val)
