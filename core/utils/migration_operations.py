...
class AlterModelBases(ModelOperation):
    """
    A migration operation for renaming a base model and rewiring
    and reloading the child models correctly. Base Django does
    not manage this properly, at least not in v2.2.
